...
function preload(){
    ...
    drinkImg = loadImage("./assets/drink.png")
...
function setup(){
   canvas = createCanvas(700, 645);
    ...
    life1 = createSprite(600,100,20,20);
    life1.addImage(lifeImg);
    life1.scale = 0.2

    life2 = createSprite(620,100,20,20);
    life2.addImage(lifeImg);
    life2.scale = 0.2

    life3 = createSprite(640,100,20,20);
    ...
    waterBar2 = createSprite(75,100,125,20);
    waterBar2.shapeColor = "grey"
    waterBar = createSprite(75,100,125,20);
    waterBar.shapeColor = "blue"
    waterIcon = createSprite(150,100,20,20)
...
function draw(){
    ...
    fill("white")
    textSize(12)
    text("Backspace to Mute Music" ,15,145);

    noStroke();
    fill("aquamarine")
    textSize(15)
    text("Game By Jishon R.", 20,630)
...
function energy(){
    if(frameCount%140===0){
        thirst = createSprite(random(200,500),1,20,20)
        thirst.addImage(drinkImg)
        thirst.scale = 0.1
        thirst.velocityY = 6
        fuel.add(thirst);
    }
